export default {
	...
	searchInformation: {
		...
		totalResults: '329000000',
		formattedTotalResults: '329,000,000'
	},
	items: [
		{
				...
				metatags: [
					{
						...
						'msapplication-tileimage':
							'/images/icons/mstile-144x144.png?2',
						'og:description':
				...
				metatags: [
					{
						...
						author: 'CNBC',
						'og:title':
							'TSLA:854.41 4.97 (0.59%) - Stock Price, Quote and News - CNBC',
						'article:author':
							'https://www.facebook.com/CNBC',
						referrer: 'unsafe-url',
						viewport:
				...
				webpage: [
					{
						...
						keywords:
							'TSLA quote, Tesla Inc, STOCK markets, CNBC',
						inlanguage: 'en-US',
						lastreviewed:
							'2017-11-13T14:04:56-0500',
						sourceorganization: 'CNBC',
						description:
							'TSLA:NASDAQ: Get Tesla Inc real-time stock quotes, news and financial information from CNBC.',
						datecreated:
							'2016-08-23T11:54:02-0400',
						url:
							'https://www.cnbc.com/quotes/?symbol=TSLA',
						contentrating: 'NR',
						datemodified:
							'2017-11-13T14:04:56-0500',
						maincontentofpage:
							'+ WATCHLIST Tesla Inc TSLA:NASDAQ Real Time Quote | Last NYSE Arca, VOL From CTA | USD Extended Hours Last Yield | 12/31/2020 704.50 % +-1.17 (+-0.17%) Change Last Yield Close | 12/31/2020...',
						name:
							'TSLA: Tesla Inc - Stock Price, Quote and News - CNBC'
					}
				],
		...
		},
		{
			...
			formattedUrl:
				'https://twitter.com/tesla?lang=en',
			htmlFormattedUrl:
				...
				metatags: [
					{
						'msapplication-tilecolor':
							'#00aced',
						'al:android:url':
							'twitter://user?screen_name=Tesla',
